...
public class PdfUpdateService {
	 ...
	 * @throws Exception
	 */
	public static void RelationAnalasisForAll(Student stu, String scope, Document pdf)
			throws DocumentException, Exception {
...
//					+ "/WebContent/Relation/" + subject[i] + "/" + scope + "/fstes.csv");
			List<String[]> fsetData = CSVUtil.importCsv("/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/" + subject[i] + "/" + scope + "/fstes.csv");
...
//			tools.InsertImg(pdf, System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/fsetsSup.png");
//			tools.InsertImg(pdf, System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/fsetsLift.png");
			tools.InsertImg(pdf, "/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
					+ subject[i] + "/" + scope + "/fsetsSup.png");
			tools.InsertImg(pdf, "/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
					+ subject[i] + "/" + scope + "/fsetsLift.png");
			pdf.newPage();
...
//					+ "/WebContent/Relation/" + subject[i] + "/" + scope + "/rules.csv");
			List<String[]> rulesData = CSVUtil.importCsv("/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/" + subject[i] + "/" + scope + "/rules.csv");
			pdf.add(para);
			temp = new String[4];
...
//			tools.InsertImg(pdf, System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/ScottPlot.png");
//			ImagUtil.resizeImage(System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/", "GroupedMatrix.png", "GroupedMatrix(1).png", 700, 1000);
//			tools.InsertImg(pdf, System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/GroupedMatrix(1).png");
//			ImagUtil.resizeImage(System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/", "Graph.png", "Graph.png(1).png", 750, 900);
//			tools.InsertImg(pdf, System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Relation/"
//					+ subject[i] + "/" + scope + "/Graph.png(1).png");
			tools.InsertImg(pdf, "/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
					+ subject[i] + "/" + scope + "/ScottPlot.png");
			ImagUtil.resizeImage("/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
					+ subject[i] + "/" + scope + "/", "GroupedMatrix.png", "GroupedMatrix(1).png", 700, 1000);
			tools.InsertImg(pdf, "/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
					+ subject[i] + "/" + scope + "/GroupedMatrix(1).png");
			ImagUtil.resizeImage("/Users/vengeance/Documents/workspaceMars/exam/WebContent/Relation/"
	 ...
	 * @throws Exception
	 */
	public static void ClusterAnalasisForAll(Student stu, String scope, Document pdf)
			throws DocumentException, Exception {
	...
	public void PdfForAll(Student stu, String scope) throws Exception {
		...
		// Document pdf =
		// pdftool.createDocument(System.getProperty("user.dir").replace("\\",
		// "/")
		// +"/WebContent/Grades/"
		// +stu.getSname()
		// +scope
		// +"分析报告.pdf");
		Document pdf = pdftool.createDocument("/Users/vengeance/Documents/workspaceMars/exam/WebContent/Grades/"
				+ stu.getSname() + scope + "分析报告.pdf");
		pdf.open();
	...
	public static void main(String[] args) throws BadElementException, IOException, Exception {
		PDFUtil pdftool = new PDFUtil();
		Document pdf = pdftool.createDocument(
				System.getProperty("user.dir").replace("\\", "/") + "/WebContent/Grades/" + "分析报告1.pdf");
		pdf.open();
