...
public class StudentGradeServlet extends BaseServlet {
	 ...
	 * @throws IOException
	 */
	public void courseInfo(HttpServletRequest request, HttpServletResponse response)
	 ...
	 * 判断学科得到语数英走势图
	 */
	private void chooseCourseByName(HttpServletRequest request, HttpServletResponse response, String studentID)
			throws ServletException, IOException {
		...
		if ("chinese".equals(course)) {
			...
			// else{
			// request.setAttribute("stuScoreList",
			// studentService.lackOfStudent());
			// }
			...
			if (studentID == null) {
				...
				// request.setAttribute("StuAllList",
				// studentService.stuthreeScores(studentID));
			}
	 ...
	 * @throws IOException
	 */
	private void setCourseID(HttpServletRequest request, HttpServletResponse response, String courseID)
			throws ServletException, IOException {
