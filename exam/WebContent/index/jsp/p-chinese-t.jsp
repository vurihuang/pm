									...
									.selectWidget(
											{
												change : function(changes) {
													...
													grade = $("#grade-select")
															.val();
													location.href = "<c:url value='/TeacherTestServlet?method=loadGrade&grade='/>"
															+ grade
															+ "&subject="
															+ subject;
												},
									...
									.selectWidget(
											{
												change : function(changes) {
													...
													grade = $("#grade-select")
															.val();
													location.href = "<c:url value='/TeacherTestServlet?method=loadGrade&testID='/>"
															+ testID
															+ "&grade="
															+ grade
															+ "&subject="
		...
		$(document)
				.ready(
						function() {
							...
							seriesData
									.push(parseFloat("${vQuestion.wrong * 100}"));/*  把错误率的值扩大100倍*/
							</c:forEach>
							//有值才赋值，没值就展现初始值
