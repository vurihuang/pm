                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="<c:url value='/s_grade_t.jsp'/>">综合</a>
                                </li>
                                <li>
                                    <a href="<c:url value='/s_chinese_t.jsp'/>">语文</a>
                                </li>
								<li>
                                    <a href="<c:url value='/s_math_t.jsp'/>">数学</a>
                                </li>
                                <li>
                                    <a href="<c:url value='/s_english_t.jsp'/>">英语</a>
                                </li>
                            </ul>
                        </li>
                        <li>
